...
class GameModel{
    ...
    makeMove(id){
      ...
      var lastPointer = (this.lastPointer===undefined || this.selectAny)?SubBoard.getSubBoard(id):this.lastPointer;
      grid.icon = this.turn;
  //    console.log("lastPointer: "+lastPointer+", pointer: "+grid.pointer);
      ...
      if(winner !=="none"){
        ...
        var won = this.macroBoard.addGrid(lastPointer,winner);
         ...
         console.log("won: "+won);
        if(won !== "none"){
          console.log("WINNER WINNER CHICKEN DINNER: "+won);
          this.gameOver = true;
          this.winner = won;
        }
      }
